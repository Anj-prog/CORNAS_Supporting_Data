...
# normalizations
mynoiseqtest1 = noiseq(testdata1 , k = 0.5, norm = "n", factor = "Tissue", pnr = 0.2, nss = 5, v = 0.02, lc = 0, replicates = "no")

write.table(mynoiseqtest1@results[[1]], file=paste(outfile, "noiseq-sim.nonormlen.tab", sep="_"), sep="\t", row.names=TRUE)
